"""
INSURANCE CLAIMS PREDICTION - ML PIPELINE (WITH MODEL SAVING)
=============================================================
Binary Classification: Will a policy result in a claim? (Yes=1, No=0)
This version saves the trained model for later use.
"""
...
print("="*70)
print("INSURANCE CLAIMS PREDICTION - ML PIPELINE (WITH MODEL SAVING)")
print("="*70)
...
# ============================================================
print("\n[STEP 14] Saving Model and Results...")
print("-" * 70)
...
joblib.dump(X_encoded.columns.tolist(), feature_cols_filename)
...
# Save training history (metrics dict)
...
metrics_history_df.to_csv('training_history.csv', index=False)
...
✓ COMPLETED STEPS:
  ...
  4. ✓ Cleaned data: Removed duplicates and handled missing values
  ...
  14. ✓ Saved model: Model serialized to disk
...
✓ OUTPUT FILES CREATED:
  • insurance_claims_model.pkl - Trained model (READY TO USE!)
  • feature_columns.pkl - Feature column names
  • feature_importance.csv - Feature importance
  • model_performance.csv - Performance metrics
  • training_history.csv - Training vs Testing metrics
  • confusion_matrix.csv - Confusion matrix

🎯 NEXT STEPS:
  1. Use 'predict_with_model.py' to make predictions on new data
  2. Use 'visualize_performance.py' to plot training vs testing performance
""")
